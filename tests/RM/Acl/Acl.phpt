...
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'detail'));
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'detail', 1)); // I, robot
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'detail', 2)); // 2001: A Space Odyssey

Assert::same(FALSE, $acl->isAllowed($user, 'book', 'publish'));
Assert::same(FALSE, $acl->isAllowed($user, 'book', 'publish', 1)); // I, robot
Assert::same(FALSE, $acl->isAllowed($user, 'book', 'publish', 2)); // 2001: A Space Odyssey

Assert::same(TRUE, $acl->isAllowed($user, 'book', 'comment'));
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'comment', 1)); // I, robot
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'comment', 2)); // 2001: A Space Odyssey
...
$user = Mockery::mock('Nette\Security\User')
	->shouldReceive('getId')->andReturn(3)
	->shouldReceive('getRoles')->andReturn(['author'])
	->getMock();

Assert::same(FALSE, $acl->isAllowed($user, 'book'));
Assert::same(TRUE, $acl->isAllowed($user, 'book', NULL, 1)); // I, robot
Assert::same(FALSE, $acl->isAllowed($user, 'book', NULL, 2)); // 2001: A Space Odyssey
...
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'publish'));
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'publish', 1)); // I, robot
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'publish', 2)); // 2001: A Space Odyssey
...
$user = Mockery::mock('Nette\Security\User')
	->shouldReceive('getId')->andReturn(4)
	->shouldReceive('getRoles')->andReturn(['author'])
	->getMock();

Assert::same(FALSE, $acl->isAllowed($user, 'book'));
Assert::same(FALSE, $acl->isAllowed($user, 'book', NULL, 1)); // I, robot
Assert::same(TRUE, $acl->isAllowed($user, 'book', NULL, 2)); // 2001: A Space Odyssey
...
$user = Mockery::mock('Nette\Security\User')
	->shouldReceive('getId')->andReturn(5)
	->shouldReceive('getRoles')->andReturn(['superadmin'])
	->getMock();

Assert::same(TRUE, $acl->isAllowed($user, 'book'));
Assert::same(TRUE, $acl->isAllowed($user, 'book', NULL, 1)); // I, robot
Assert::same(TRUE, $acl->isAllowed($user, 'book', NULL, 2)); // 2001: A Space Odyssey
...
Assert::same(TRUE, $acl->isAllowed($user, 'book', 'undefined'));
Assert::same(FALSE, $acl->isAllowed($user, 'undefined', 'undefined'));
*/
$disconnect($database);
